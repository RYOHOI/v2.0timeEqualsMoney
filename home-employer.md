...
### 全部录用
标题右侧有可选动作「全部录用」，批量录用所有未被处理的兼客。点击后弹框确认。

## 已完成
![image](img/home-b-finished.png)

对于「正在招人」中已结束的岗位，如雇主处理完了全部报名兼客，则该岗位自动挪到「已完成」中。
...
#### 评星级控件
星级评价，支持手势拖动更改星级。拖动过程中，右侧出现「4 分」「5 分」等字样。最低为一颗星。

### 群发消息
![image](img/group-msg.png)

点击浮动圆按钮弹框要求选择「群发即时消息」「群发手机短信」。
