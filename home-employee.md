...
- 同一天最多可报 3 份普通兼职或抢单兼职。点击抢单或报名弹框提示「一天最多参加 3 次兼职哦！别把自己累坏了~」
...
### 选择工作日期
对于一天以上且薪资单位为「元/天」「元/时」的普通兼职，报名时弹框要求兼客选择若干空闲日。其他情况直接弹框提示报名成功。
...
### 报名按钮
兼客可点击岗位要求下方的长条状「报名」按钮或右下方浮动圆按钮报名。如报名成功，则条状按钮置灰，变为「已报名」，且浮动圆按钮动作变为「联系雇主」。
...
### 雇主答疑
报名或抢单前不对兼客公开雇主联系方式，开启评论功能，支持兼客在报名前与雇主建立起沟通渠道。评论内容对所有用户公开。仅支持一问一答，不支持兼客互相回复。
